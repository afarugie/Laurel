...
class RouterTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('Route', $actual);
    }
    ...
    public function testAddAndGenerate()
    {
        ...
        // fail to match
        $this->setExpectedException('RouteNotFound');
    ...
    public function testGetAndSetRoutes()
    {
        ...
        $this->assertInstanceOf('RouteCollection', $actual);
        $this->assertTrue(count($actual) == 2);
        $this->assertInstanceOf('Route', $actual['page.browse']);
        $this->assertEquals('/page/', $actual['page.browse']->path);
        $this->assertInstanceOf('Route', $actual['page.read']);
    ...
    public function testArrayAccess()
    {
        ...
        $this->setExpectedException('UnexpectedValue');
