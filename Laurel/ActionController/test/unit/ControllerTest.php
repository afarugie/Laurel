...
class ControllerTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->assertInstanceOf('TemplateRegistry', $this->view->getViewRegistry());
        $this->assertInstanceOf('TemplateRegistry', $this->view->getLayoutRegistry());
        $this->assertInstanceOf('HelperRegistry', $this->view->getHelpers());
    }
    ...
    public function testMapFilesToTemplateRegistryOnConstruct()
    {
        ...
        $view = new View(
            new TemplateRegistry(array('foo' => __DIR__ . '/unit/foo_template.php')),
